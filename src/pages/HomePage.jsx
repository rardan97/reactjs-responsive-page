      ...
      <div className='container mx-auto px-4'>
        ...
        <div className="hero grid md:grid-cols-2 grid-cols-1 items-center gap-20 pt-32" id="home">
          <div className='box'>
            ...
            <p className="text-base/8 mb-7">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur similique aspernatur nulla tempore at saepe vero ut quia placeat magnam!</p>
        ...
        <div className="about grid md:grid-cols-2 grid-cols-1 items-center md:gap-20 gap-10 md:pt-20 pt-32" id="about">
          ...
          <h1 className="lg:text-5xl/tight text-3xl font-medium mb-7">Belajar Membuat Website Dengan <span className="font-bold text-sky-400 underline">Tailwind CSS</span></h1>
          <p className="text-base/loose">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequatur similique aspernatur nulla tempore at saepe vero ut quia placeat magnam!</p>
          </div>
        </div>
        ...
        <div className="service pt-32" id="service">
          ...
          <div className="service-box pt-12 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box bg-sky-400 rounded-lg shadow p-4">
              ...
              <p className="text-white text-base/loose">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sapiente veniam, magni beatae quia dolore placeat.</p>
            </div>
            <div className="box bg-sky-400 rounded-lg shadow p-4">
        ...
        <div className="proyek pt-32" id="proyek">
          ...
          <div className="proyek-box pt-12 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box p-2 bg-white shadow">
              ...
              <p className="text-base/loose">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non illum libero beatae minus recusandae veritatis.</p>
            </div>
            <div className="box p-2 bg-white shadow">
